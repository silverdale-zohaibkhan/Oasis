# Plex to Odoo field mapping - wade_management
...
| `02_mdm_v1_customers_full_history.csv` | 35 |
| `03_mdm_v1_contacts_full_history.csv` | 53 |
| `04_mdm_v1_suppliers_full_history.csv` | 501 |
| `05_mdm_v1_operations_full_history.csv` | 8 |
| `06_mdm_v1_employees_full_history.csv` | 0 |
| `07_mdm_v1_buildings_full_history.csv` | 1 |
| `08_mdm_v1_supply_items_full_history.csv` | 154 |
| `09_inventory_v1_inventory_definitions_locations_full_history.csv` | 1 |
...
| `12_purchasing_v1_item_suppliers_full_history.csv` | 142 |
...
| `16_purchasing_v1_purchase_orders_full_history.csv` | 275 |
| `17_purchasing_v1_receipts_full_history.csv` | 1062 |
| `18_accounting_v1_journal_entries_full_history.csv` | 2267 |
| `19_accounting_v1_ap_invoices_full_history.csv` | 8453 |
| `20_accounting_v1_ar_invoices_full_history.csv` | 550 |
