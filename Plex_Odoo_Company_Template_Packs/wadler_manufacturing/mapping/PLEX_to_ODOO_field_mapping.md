# Plex to Odoo field mapping - wadler_manufacturing

## Source datasets found

| Plex file | Data rows |
|---|---:|
| `01_mdm_v1_parts_full_history.csv` | 103 |
| `02_mdm_v1_customers_full_history.csv` | 140 |
| `03_mdm_v1_contacts_full_history.csv` | 1197 |
| `04_mdm_v1_suppliers_full_history.csv` | 182 |
| `05_mdm_v1_operations_full_history.csv` | 4 |
| `06_mdm_v1_employees_full_history.csv` | 2 |
| `07_mdm_v1_buildings_full_history.csv` | 2 |
| `08_mdm_v1_supply_items_full_history.csv` | 18 |
| `09_inventory_v1_inventory_definitions_locations_full_history.csv` | 7 |
| `10_inventory_v1_inventory_tracking_containers_full_history.csv` | 206 |
| `11_inventory_v1_inventory_tracking_lots_full_history.csv` | 0 |
| `12_purchasing_v1_item_suppliers_full_history.csv` | 7 |
| `13_purchasing_v1_approved_suppliers_full_history.csv` | 21 |
| `14_sales_v1_price_adjustments_full_history.csv` | 4 |
| `15_sales_v1_orders_full_history.csv` | 2320 |
| `16_purchasing_v1_purchase_orders_full_history.csv` | 141 |
| `17_purchasing_v1_receipts_full_history.csv` | 584 |
| `18_accounting_v1_journal_entries_full_history.csv` | 1867 |
| `19_accounting_v1_ap_invoices_full_history.csv` | 1918 |
| `20_accounting_v1_ar_invoices_full_history.csv` | 2442 |
| `21_shipping_v1_beta1_transfer_orders_full_history.csv` | 0 |
| `22_inventory_v1_inventory_history_container_adjustments_full_history.csv` | 791 |
| `23_engineering_v1_boms_components_full_history.csv` | 175 |
